...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const embed = new MessageEmbed()
            ...
            .setAuthor({
                name: 'Satxler Informations',
                iconURL: (
                    await client.guilds
                        .fetch('1213550226128765019')
                        .catch(() => null)
                )?.members?.cache
                    ?.get('1212431696381612132')
                    ...
                    const em = new MessageEmbed()
                        .setDescription(
                            `**__Developers__**\n[\`1\`] ${
                                status[
                                    client.guilds.cache
                                        .get('1213550226128765019')
                                        ?.members?.cache?.get(
                                            '1212431696381612132'
                                        )?.presence?.status || 'offline'
                                ]
                            }  [Bablu Watson </>](https://discord.gg/users/1212431696381612132)\n\n**__Core Team__**\n[\`1\`] ${
                                status[
                                    client.guilds.cache
                                        .get('1213550226128765019')
                                        ?.members?.cache?.get(
                        ...
                        .setAuthor({
                            ...
                            iconURL: client.guilds.cache
                                .get('1213550226128765019')
                                ?.members?.cache?.get('1212431696381612132')
                                ?.user?.displayAvatarURL({ dynamic: true })
                        })
                        .setFooter({
                            text: `Requested By ${message.author.tag}`,
                        ...
                        msg.edit({
                            embeds: [
                                new MessageEmbed()
                                    ...
                                    .setDescription(
                                        '<:Satxler_mainrole:1181290802022977576> | **Fetching** all the **resources**...'
                                    )
                            ]
                        })
